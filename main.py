...
token = "OTM4NzM0NDYyNDg3OTEyNDc5.Yfum4w.y5tcUImKoRwjyrqNMAXrzGTi5x4"

token2 = "OTUxNTI1NTE1Nzc5NTM0ODk4.YiovXw.Kj4X9XoslQerzCXolVeqFYa5WuA"

# input(f"{Fore.LIGHTCYAN_EX}Your Token Here:")
